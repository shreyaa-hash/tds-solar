...
<head>
    ...
    <script>
        ...
        gtag('config', 'G-J7PM7EGK4D');
    </script>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />

    <title>TDS Solar Energy</title>
    <link rel="canonical" href="#" /><!-- public start -->
    ...
    <script>
        window.onload = function () {
            dataStatistics("/En/Index/dataStatistics?&catid=11");
        }
    </script>
    <style>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-3KH9X2YCMS"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag() { dataLayer.push(arguments); }
        gtag('js', new Date());

        gtag('config', 'G-3KH9X2YCMS');
    </script>
</head>
...
<body>
    ...
    <div class="ys-page-wrap inside-main explore-main">
        <!-- Top navigation -->
                        ...
                        <div class="yhpr-left">
                            ...
                            <div class="yhpr-bottom">
                                <ul class="head-nav">
                                    ...
                                    <li class="head-nav-item ">
                                        <div class="head-nav-item-nub">
                                            <a href="company.php" target="_self" class="head-nav-item-title">Company</a>
                                            <!-- Dropdown -->
                                        </div>
                                    </li>
                                    <li class="head-nav-item ">
        ...
        <main class="ys-main">
            ...
            <section class="ys-nybanner">
                <div class="ys-nyban-img">
                    <img class="ys-nyban-pc" src="Public/Uploads/uploadfile/images/20251126/Frame1618874302.jpg"
                        alt="Frame 1618874302.jpg">
                    <img class="ys-nyban-ph" src="Public/Uploads/uploadfile/images/20251126/e2bannerph.jpg"
                        alt="e2_banner_ph.jpg">
                </div>
                <div class="ys-nyban-title ys-cont1600 ys-pos-center">
                    <h1 class="std-font72  wow ys-fadeup1">WE NEVER STOP EXPLORING</h1>
                </div>
            ...
            <section class="explore-booth">
                <div class="ys-cont1600">
                    <a href="news/41.php" class="explore-booth-link">
                        <div class="explore-booth-left ys-imgbox-cover  wow ys-fadeup1">
                            <img src="Public/En/images/e2_img_01un.png" alt="">
                            <img src="Public/Uploads/uploadfile/images/20260424/4.24-420.jpg" alt="4.24.jpg">
                        </div>
                        <div class="explore-booth-right  wow ys-fadeup2">
                            <div class="std-text16 explore-booth-right-date">
                                April 23, 2026 </div>
                            <div class="std-font32 explore-booth-right-tit">
                                TDS SOLAR ENERGY: Trusted Solar Solutions Provider Across Uttar Pradesh </div>
                            <div class="std-text16 explore-booth-right-txt">
                                <p>
                                    FATEHPUR, Uttar Pradesh, April 23, 2026 -- TDS SOLAR ENERGY, a trusted solar
                                    solutions provider established in 2016, continues to deliver reliable solar products
                                    and professional installation services for homes, businesses, and industries across
                                    Uttar Pradesh. </p>
                            </div>
                            <div class="std-btnx4">
                                <div class="std-btnx4-link">
                                    <div class="ys-imgbox-cover">
                                        <img src="Public/En/images/a2_icon01.svg" alt="" class="std-btnx4-link-img1">
                                        <img src="Public/En/images/a2_icon01_1.svg" alt="" class="std-btnx4-link-img2">
                                    </div>
            ...
            <section class="explore-list" data-page="1">
                <div class="ys-cont1600">
                    <div class="explore-list-case">
                        <ul class="explore-list-inof">
                            <li class="explore-list-inof-nub  wow ys-fadeup1">
                                <a href="news/39.php" class="elin-box" title="">
                                    <div class="ys-imgbox-cover elin-box-pic">
                                        <img src="Public/En/images/0newmyop.png" alt="">
                                        <img src="Public/Uploads/uploadfile/images/20260413/413.jpg" alt="413.jpg">
                                    </div>
                                    <div class="std-text16 elin-box-date">
                                        April 13, 2026 </div>
                                    <div class="std-font20 elin-box-tit">
                                        TDS Solar Energy Delivers Reliable Solar Systems for Better Energy Management
                                    </div>
                                    <div class="std-btnx4">
                                        <div class="std-btnx4-link">
                                            <div class="ys-imgbox-cover">
                            ...
                            <li class="explore-list-inof-nub  wow ys-fadeup1">
                                <a href="news/40.php" class="elin-box" title="">
                                    <div class="ys-imgbox-cover elin-box-pic">
                                        <img src="Public/En/images/0newmyop.png" alt="">
                                        <img src="Public/Uploads/uploadfile/images/20260417/ying417.jpg"
                                            alt="ying417.jpg">
                                    </div>
                                    <div class="std-text16 elin-box-date">
                                        April 08, 2026 </div>
                                    <div class="std-font20 elin-box-tit">
                                        A Promise to Uttar Pradesh: TDS SOLAR ENERGY Continues Delivering Reliable Solar
                                        Solutions
                                    </div>
                                    <div class="std-btnx4">
                                        <div class="std-btnx4-link">
                            ...
                            <li class="explore-list-inof-nub  wow ys-fadeup1">
                                <a href="news/38.php" class="elin-box" title="">
                                    <div class="ys-imgbox-cover elin-box-pic">
                                        <img src="Public/En/images/0newmyop.png" alt="">
                                        <img src="Public/Uploads/uploadfile/images/20260328/20260325news.jpg"
                                            alt="20260325-news.jpg">
                                    </div>
                                    <div class="std-text16 elin-box-date">
                                        March 25, 2026 </div>
                                    <div class="std-font20 elin-box-tit">
                                        TDS SOLAR ENERGY: A Trusted Choice for Solar Installations in Uttar Pradesh
                                    </div>
                                    <div class="std-btnx4">
                                        <div class="std-btnx4-link">
                                            <div class="ys-imgbox-cover">
                            ...
                            <li class="explore-list-inof-nub  wow ys-fadeup1">
                                <a href="news/37.php" class="elin-box" title="">
                                    <div class="ys-imgbox-cover elin-box-pic">
                                        <img src="Public/En/images/0newmyop.png" alt="">
                                        <img src="Public/Uploads/uploadfile/images/20260328/20260318news.jpg"
                                            alt="20260318-news.jpg">
                                    </div>
                                    <div class="std-text16 elin-box-date">
                                        March 18, 2026 </div>
                                    <div class="std-font20 elin-box-tit">
                                        TDS SOLAR ENERGY Strengthens Its Commitment to Clean and Sustainable Solar Power
                                    </div>
                                    <div class="std-btnx4">
                                        <div class="std-btnx4-link">
                                            <div class="ys-imgbox-cover">
                            ...
                            <li class="explore-list-inof-nub  wow ys-fadeup1">
                                <a href="news/30.php" class="elin-box" title="">
                                    <div class="ys-imgbox-cover elin-box-pic">
                                        <img src="Public/En/images/0newmyop.png" alt="">
                                        <img src="Public/Uploads/uploadfile/images/20260317/20260314news.jpg"
                            ...
                            <li class="explore-list-inof-nub  wow ys-fadeup1">
                                <a href="news/29.php" class="elin-box" title="">
                                    <div class="ys-imgbox-cover elin-box-pic">
                                        <img src="Public/En/images/0newmyop.png" alt="">
                                    ...
                                    <div class="std-text16 elin-box-date">
                                        March 07, 2026 </div>
                                    <div class="std-font20 elin-box-tit">
                                        TDS SOLAR ENERGY Achieves Record 97% Energy Storage Efficiency under HTW
                                        Rankings </div>
                                    <div class="std-btnx4">
                                        <div class="std-btnx4-link">
                                            <div class="ys-imgbox-cover">
                            ...
                            <li class="explore-list-inof-nub  wow ys-fadeup1">
                                <a href="news/31.php" class="elin-box" title="">
                                    <div class="ys-imgbox-cover elin-box-pic">
                                        <img src="Public/En/images/0newmyop.png" alt="">
                                        <img src="Public/Uploads/uploadfile/images/20260317/226383.jpg"
                                            alt="226-383.jpg">
                                    </div>
                                    <div class="std-text16 elin-box-date">
                                        February 24, 2026 </div>
                                    <div class="std-font20 elin-box-tit">
                                        TDS SOLAR ENERGY Enhances Versatile Energy Storage Solutions with the New H3 PRO
                                        Hybrid
                                        Inverter </div>
                                    <div class="std-btnx4">
                                        <div class="std-btnx4-link">
                            ...
                            <li class="explore-list-inof-nub  wow ys-fadeup1">
                                <a href="news/32.php" class="elin-box" title="">
                                    <div class="ys-imgbox-cover elin-box-pic">
                                        <img src="Public/En/images/0newmyop.png" alt="">
                                        <img src="Public/Uploads/uploadfile/images/20260317/213.jpg" alt="213.jpg">
                                    </div>
                                    <div class="std-text16 elin-box-date">
                                        February 12, 2026 </div>
                                    <div class="std-font20 elin-box-tit">
                                        TDS SOLAR ENERGY Strengthens Its Solar Solutions Network Across Uttar Pradesh
                                    </div>
                                    <div class="std-btnx4">
                                        <div class="std-btnx4-link">
                                            <div class="ys-imgbox-cover">
                            ...
                            <li class="explore-list-inof-nub  wow ys-fadeup1">
                                <a href="news/33.php" class="elin-box" title="">
                                    <div class="ys-imgbox-cover elin-box-pic">
                                        <img src="Public/En/images/0newmyop.png" alt="">
                                    ...
                                    <div class="std-font20 elin-box-tit">
                                        TDS SOLAR ENERGY Builds Trust Through Quality Solar Products and Professional
                                        Service
                                    </div>
                                    <div class="std-btnx4">
                                        <div class="std-btnx4-link">
                    ...
                    <div class="ys-pcfy wow ys-fadeup2">
                        <ul class="pc-fenye clearfix">
                            <li data-page="1" class="comp-tabli activepage">1</li><a data-page="2" class="comp-tabli"
                                href="news-2.php">
                                <li>2</li>
                            </a><a data-page="3" class="comp-tabli" href="news-3.php">
                                <li>3</li>
                            </a><a data-page="4" class="comp-tabli" href="news-4.php">
                                <li>4</li>
                            </a> <a data-page="2" class="next" href="news-2.php">
                                <li></li>
                            </a> <a data-page="4" class="end" href="news-4.php">
                                <li></li>
                            </a>
                        </ul>
                    </div>
            ...
            <section class="mod-footvideo">
                <div class="ys-footer-video">
                    ...
                    <!-- Hide when there is no video -->
                    <video class='ys-ban-video' src='Public/Uploads/uploadfile/files/20251217/dibushipin.mp4' loop muted
                        poster='Public/Uploads/uploadfile/images/20251202/download-398.jpg'></video>
                </div>
    ...
    <script>
        var tp = "" ? "1" : "";
        ys.yxtop({ tp: tp, navHeight: $(".ys-hd-pc").height() });
        $(function () {
