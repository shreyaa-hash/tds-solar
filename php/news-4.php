...
<head>
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-J7PM7EGK4D"></script>
    <script>
    ...
    <link rel="canonical" href="news-4.php" /><!-- public start -->
                    ...
                    <a href="news/41.php" class="explore-booth-link">
                        ...
                        <div class="explore-booth-right  wow ys-fadeup2">
                            ...
                            <div class="std-font32 explore-booth-right-tit">
                                TDS SOLAR ENERGY in Residential Energy Storage </div>
                            <div class="std-text16 explore-booth-right-txt">
                                <p>
                                    India, April 23, 2026 -- TDS SOLAR ENERGY, a global leader in renewable energy
                ...
                <div class="ys-cont1600">
                    <div class="explore-list-case">
                        <ul class="explore-list-inof">
                            <li class="explore-list-inof-nub  wow ys-fadeup1">
                                <a href="news/10.php" class="elin-box" title="">
                                    <div class="ys-imgbox-cover elin-box-pic">
                                        <img src="Public/En/images/0newmyop.png" alt="">
                                        <img src="Public/Uploads/uploadfile/images/20251107/11.jpg" alt="11.jpg">
                                    </div>
                                    <div class="std-text16 elin-box-date">
                                        November 20, 2019 </div>
                                    <div class="std-font20 elin-box-tit">
                                        Octopus Energy and Co-op Energy launch community energy joint venture </div>
                                    <div class="std-btnx4">
                                        <div class="std-btnx4-link">
                                            <div class="ys-imgbox-cover">
                            ...
                            <li class="explore-list-inof-nub  wow ys-fadeup1">
                                <a href="news/9.php" class="elin-box" title="">
                                    <div class="ys-imgbox-cover elin-box-pic">
                                        <img src="Public/En/images/0newmyop.png" alt="">
                                        <img src="Public/Uploads/uploadfile/images/20251107/12.jpg" alt="12.jpg">
                                    </div>
                                    <div class="std-text16 elin-box-date">
                                        November 20, 2019 </div>
                                    <div class="std-font20 elin-box-tit">
                                        UK will need 1,400GWh of energy storage for future energy </div>
                                    <div class="std-btnx4">
                                        <div class="std-btnx4-link">
                                            <div class="ys-imgbox-cover">
                                                <img src="Public/En/images/a2_icon01.svg" alt=""
                    ...
                    <div class="ys-pcfy wow ys-fadeup2">
                        <ul class="pc-fenye clearfix">
                            ...
                            </a> <a data-page="3" class="prev" href="news-3.php">
                                <li></li>
                            ...
                            <li data-page="4" class="comp-tabli activepage">4</li>
                        </ul>
                    </div>
                </div>
            </section>
