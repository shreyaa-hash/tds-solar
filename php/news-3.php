...
<head>
    ...
    <link rel="canonical" href="news-3.php" /><!-- public start -->
                    ...
                    <a href="news/41.php" class="explore-booth-link">
                        ...
                        <div class="explore-booth-right  wow ys-fadeup2">
                            ...
                            <div class="std-text16 explore-booth-right-txt">
                                <p>
                                    India, April 23, 2026 -- TDS SOLAR ENERGY, a global leader in renewable
                                    energy
                                    solutions, has been ranked No. 1 among residential energy storage providers
                                    worldwide for 2025, based on MWh shipments in S&P Global Energy's Residential Energy
                                    Storage Market Tracker. </p>
                            </div>
                            <div class="std-btnx4">
                ...
                <div class="ys-cont1600">
                    <div class="explore-list-case">
                        <ul class="explore-list-inof">
                            <li class="explore-list-inof-nub  wow ys-fadeup1">
                                <a href="news/22.php" class="elin-box" title="">
                                    <div class="ys-imgbox-cover elin-box-pic">
                                        <img src="Public/En/images/0newmyop.png" alt="">
                                        <img src="Public/Uploads/uploadfile/images/20260317/1764236894602304.jpg"
                                            alt="1764236894602304.jpg">
                                    </div>
                                    <div class="std-text16 elin-box-date">
                                        February 07, 2025 </div>
                                    <div class="std-font20 elin-box-tit">
                                        TDS SOLAR ENERGY Achieves HTW 2025 A-Class Certification for Energy Storage
                                        System </div>
                                    <div class="std-btnx4">
                                        <div class="std-btnx4-link">
                                            <div class="ys-imgbox-cover">
                            ...
                            <li class="explore-list-inof-nub  wow ys-fadeup1">
                                <a href="news/18.php" class="elin-box" title="">
                                    <div class="ys-imgbox-cover elin-box-pic">
                                        <img src="Public/En/images/0newmyop.png" alt="">
                                        <img src="Public/Uploads/uploadfile/images/20260317/1764237004992611.jpg"
                                            alt="1764237004992611.jpg">
                                    </div>
                                    <div class="std-text16 elin-box-date">
                                        May 25, 2024 </div>
                                    <div class="std-font20 elin-box-tit">
                                        Top Brand PV! TDS SOLAR ENERGY Celebrates Again by Leading Industry Researchers
                                    </div>
                                    <div class="std-btnx4">
                                        <div class="std-btnx4-link">
                                            <div class="ys-imgbox-cover">
                            ...
                            <li class="explore-list-inof-nub  wow ys-fadeup1">
                                <a href="news/16.php" class="elin-box" title="">
                                    <div class="ys-imgbox-cover elin-box-pic">
                                        <img src="Public/En/images/0newmyop.png" alt="">
                                        <img src="Public/Uploads/uploadfile/images/20251126/Frame1618873903-72.jpg"
                                            alt="Frame 1618873903.jpg">
                                    </div>
                                    <div class="std-text16 elin-box-date">
                                        March 07, 2024 </div>
                                    <div class="std-font20 elin-box-tit">
                                        TDS SOLAR ENERGY new project All UP </div>
                                    <div class="std-btnx4">
                                        <div class="std-btnx4-link">
                                            <div class="ys-imgbox-cover">
                                                <img src="Public/En/images/a2_icon01.svg" alt=""
                            ...
                            <li class="explore-list-inof-nub  wow ys-fadeup1">
                                <a href="news/15.php" class="elin-box" title="">
                                    <div class="ys-imgbox-cover elin-box-pic">
                                        <img src="Public/En/images/0newmyop.png" alt="">
                                        <img src="Public/Uploads/uploadfile/images/20260317/1764237130866706.jpg"
                                            alt="1764237130866706.jpg">
                                    </div>
                                    <div class="std-text16 elin-box-date">
                                        August 16, 2023 </div>
                                    <div class="std-font20 elin-box-tit">
                                        TDS SOLAR ENERGY Receives Multiple Top Brand PV Seals in 2023 </div>
                                    <div class="std-btnx4">
                                        <div class="std-btnx4-link">
                                            <div class="ys-imgbox-cover">
                                                <img src="Public/En/images/a2_icon01.svg" alt=""
                            ...
                            <li class="explore-list-inof-nub  wow ys-fadeup1">
                                <a href="news/14.php" class="elin-box" title="">
                                    <div class="ys-imgbox-cover elin-box-pic">
                                        <img src="Public/En/images/0newmyop.png" alt="">
                                        <img src="Public/Uploads/uploadfile/images/20251126/Frame1618873903-743.jpg"
                                            alt="Frame 1618873903.jpg">
                                    </div>
                                    <div class="std-text16 elin-box-date">
                                        July 14, 2023 </div>
                                    <div class="std-font20 elin-box-tit">
                                        TDS SOLAR ENERGY received multiple Top Brand PV seals from EUPD Research in 2023
                                    </div>
                                    <div class="std-btnx4">
                                        <div class="std-btnx4-link">
                                            <div class="ys-imgbox-cover">
                            ...
                            <li class="explore-list-inof-nub  wow ys-fadeup1">
                                <a href="news/13.php" class="elin-box" title="">
                                    <div class="ys-imgbox-cover elin-box-pic">
                                        <img src="Public/En/images/0newmyop.png" alt="">
                                        <img src="Public/Uploads/uploadfile/images/20251126/Frame1618873903-899.jpg"
                                            alt="Frame 1618873903.jpg">
                                    </div>
                                    <div class="std-text16 elin-box-date">
                                        February 09, 2023 </div>
                                    <div class="std-font20 elin-box-tit">
                                        FoxESS UK Launch ‘Elite Installer’ Programme </div>
                                    <div class="std-btnx4">
                                        <div class="std-btnx4-link">
                                            <div class="ys-imgbox-cover">
                                                <img src="Public/En/images/a2_icon01.svg" alt=""
                            ...
                            <li class="explore-list-inof-nub  wow ys-fadeup1">
                                <a href="news/12.php" class="elin-box" title="">
                                    <div class="ys-imgbox-cover elin-box-pic">
                                        <img src="Public/En/images/0newmyop.png" alt="">
                                        <img src="Public/Uploads/uploadfile/images/20251126/Frame1618873903-30.jpg"
                                            alt="Frame 1618873903.jpg">
                                    </div>
                                    <div class="std-text16 elin-box-date">
                                        June 16, 2022 </div>
                                    <div class="std-font20 elin-box-tit">
                                        Progressing with honor! Fox won the EUPD “Top Brand PV Inverter” seal. </div>
                                    <div class="std-btnx4">
                                        <div class="std-btnx4-link">
                                            <div class="ys-imgbox-cover">
                                                <img src="Public/En/images/a2_icon01.svg" alt=""
                    ...
                    <div class="ys-pcfy wow ys-fadeup2">
                        <ul class="pc-fenye clearfix">
                            <a data-page="1" class="first" href="#">
                                <li class="comp-tabli"></li>
                            </a> <a data-page="2" class="prev" href="news-2.php">
                                <li></li>
                            </a> <a data-page="1" class="comp-tabli" href="#">
                                <li>1</li>
                            </a><a data-page="2" class="comp-tabli" href="news-2.php">
                                <li>2</li>
                            </a>
                            <li data-page="3" class="comp-tabli activepage">3</li><a data-page="4" class="comp-tabli"
                                href="news-4.php">
                                <li>4</li>
                            </a> <a data-page="4" class="next" href="news-4.php">
                                <li></li>
