  ...
  return (
    <Router>
      ...
      <div className="flex flex-col min-h-screen bg-background text-primary transition-colors duration-300">
        ...
        {/* 🟢 PASSING THEME STATE PROPS TO SYNC NAVBAR TOGGLER */}
        <Header theme={theme} toggleTheme={toggleTheme} />
        
        {/* 🟢 CENTRAL GLOBAL LAYOUT OVERHAUL (Edge-To-Edge Container) */}
        <main className="flex-grow w-full px-4 md:px-6 mx-auto overflow-x-hidden">
          <Routes>
            {/* Clean URLs */}
